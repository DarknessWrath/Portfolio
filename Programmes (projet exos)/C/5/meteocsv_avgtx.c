...
//  avg_tn : Moyenne des températures des minimales (Tn)
...
int avg_tn(const char *filename, float *ptr);

//--- mesure et unité

#define MEASURE_TXT "La moyenne des températures maximales annuelles"
#define UNIT_TXT    "oC"
...
int avg_tn(const char *filename, float *ptr) {
  ...
  //    && s == (somme du champ Tx des relevés lus, sans compter le dernier
  //              relevé lu si rfrs == 0, puis diviser par le nombre de relevés pour la moyenne)
